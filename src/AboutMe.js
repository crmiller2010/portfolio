...
const AboutMe=()=>{
    ...
    <div>
        <h2>About Me</h2>
        <div id="ABM">
            <img id="Avatar" src ="https://github.com/crmiller2010/portfolio/blob/main/public/ReadyPlayerMe-Avatar.png?raw=true"></img>
            <p id="about-me-paragarph">Hi my name is Chris Miller, I am a bootcamp student at the University of Wisconsin.<br></br>
                                ...
                                and time managementam. I am  excited to start a career in the world of Web Development.
            </p>
        </div>
    </div>
    )
